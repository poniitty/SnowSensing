extract_landsat <- function(aoi, site_name, aoi_size = 5, 
                            start_date = "2013-01-01", end_date = Sys.Date(), months = 1:12,
                            sats = "LC08", minclouds = 50, my_timeout = 400, info_timeout = 60, 
                            base_landsat_dir, workers = workers, data_source = "rstac"){
